...
const SRM_DATA = {
    profile: {
        "name": (typeof localStorage !== 'undefined' && localStorage.getItem('srm_display_name')) || "",
        ...
        "email": (typeof localStorage !== 'undefined' && localStorage.getItem('srm_auto_id') ? localStorage.getItem('srm_auto_id') + '@srmist.edu.in' : ""),
        "personalEmail": "",
        "mobile": "",
        "altMobile": "",
        "institution": "Faculty of Engineering and Technology, Kattankulathur",
        "campus": "Kattankulathur Campus",
        "program": (typeof localStorage !== 'undefined' && localStorage.getItem('srm_program')) || "B.Tech Computer Science & Engineering",
        "batch": "2026 Batch",
        "semester": "I SEMESTER",
        ...
        "bloodGroup": "",
        "nationality": "Indian",
        "facultyAdvisor": (typeof localStorage !== 'undefined' && localStorage.getItem('srm_advisor')) || "Faculty Advisor",
        "academicAdvisor": "",
        "orientationRoom": "University Building (UB)",
        "enrollmentDate": "",
        "parents": {
            "fatherName": "",
            "motherName": "",
